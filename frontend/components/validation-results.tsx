...
export function ValidationResults({ result, files, onReset }: ValidationResultsProps) {
  ...
  const [isLoading, setIsLoading] = useState<{ send: boolean; export: boolean }>({ send: false, export: false })
        ...
        {isSuccess && (
          <div className="flex space-x-3">
            <Button
              ...
              onClick={() => setIsLoading((prev) => ({ ...prev, send: true }))}
            ...
            <Button
              size="sm"
              className="flex items-center bg-[#0A2277] hover:bg-[#081a5e]"
              onClick={() => setIsLoading((prev) => ({ ...prev, export: true }))}
                          ...
                          <li key={index} className="flex items-start p-3 rounded-md bg-red-50 border border-red-100">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-red-700">
                                {error.documentType === "passport"
                                  ? "Missing gender information (Sex field)"
                                  : error.documentType === "form"
                                    ? "Missing specimen signature"
                                    : error.description}
                              </p>
